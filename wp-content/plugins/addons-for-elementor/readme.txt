...
= 5.3 =
* Tweak – Further performance gains by having most widgets load only the CSS they require.
* Tweak - Removed superfluous CSS files and some big CSS files were broken down into files for individual widgets
